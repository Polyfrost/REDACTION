...
import xyz.qalcyo.redaction.render.colors.CommonColors
import xyz.qalcyo.redaction.render.colors.CustomColor
import xyz.qalcyo.redaction.render.colors.MinecraftChatColors
...
class SmartFontRenderer : FontRenderer(
    ...
    fun drawString1(
        ...
        return when (alignment) {
            TextAlignment.MIDDLE -> drawString1(
                text,
            ...
            TextAlignment.RIGHT_LEFT -> drawString1(
                text,
    ...
    fun drawString1(
        ...
        posX = x
        posY = y
        return drawChars(text, color, shadow)
    }
    ...
    companion object {
        ...
        private fun decodeCommonColor(character: Char): Int? {
            if (character.lowercaseChar() == 'w') return RedactionConfig.color.rgb

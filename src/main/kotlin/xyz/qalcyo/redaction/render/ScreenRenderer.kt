package xyz.qalcyo.redaction.render
...
import xyz.qalcyo.redaction.render.SmartFontRenderer.TextAlignment
import xyz.qalcyo.redaction.render.SmartFontRenderer.TextShadow
import xyz.qalcyo.redaction.render.colors.CustomColor
...
object ScreenRenderer {
    ...
    fun drawString(
        ...
        val f = fontRenderer.drawString1(text, drawingOrigin.x + x, drawingOrigin.y + y, color, alignment, shadow)
    ...
    fun drawString(
        ...
        if (!isRendering) return -1f
        val f = fontRenderer.drawString1(text, drawingOrigin.x + x, drawingOrigin.y + y, color, if (shadow) TextShadow.NORMAL else TextShadow.NONE)
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f)
        return f
    }

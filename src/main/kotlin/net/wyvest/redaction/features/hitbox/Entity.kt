...
data class Entity(@Transient val name: String, @SerializedName("hitbox_enabled") var hitboxEnabled: Boolean = true, @SerializedName("eyeline_enabled") var eyeLineEnabled: Boolean = true, @SerializedName("line_enabled") var lineEnabled: Boolean = true, var color: Int = Color.WHITE.rgb, @SerializedName("eye_color") var eyeColor: Int = Color.RED.rgb, @SerializedName("line_color") var lineColor: Int = Color.BLUE.rgb, @Transient val condition: (net.minecraft.entity.Entity) -> Boolean, @Transient private val priority: Int) {
    ...
    companion object {
        ...
        private val living = Entity("Living", condition = {it is net.minecraft.entity.EntityLiving}, priority = Int.MAX_VALUE - 7)
        private val monster = Entity("Monster", condition = { it is net.minecraft.entity.monster.IMob }, priority = Int.MAX_VALUE - 6)
        private val minecart = Entity("Minecart", condition = { it is net.minecraft.entity.item.EntityMinecart }, priority = 1000)
        private val player = Entity("Player", condition = { it is net.minecraft.entity.player.EntityPlayer }, priority = Int.MAX_VALUE - 1)
        private val self = Entity("Self", condition = { it is net.minecraft.client.entity.EntityPlayerSP && (it as net.minecraft.entity.player.EntityPlayer).gameProfile.id == net.minecraft.client.Minecraft.getMinecraft().thePlayer.gameProfile.id }, priority = Int.MAX_VALUE)
        private val projectile = Entity("Projectile", condition = {it is net.minecraft.entity.IProjectile}, priority = -1)
        private val witherSkull = Entity("Wither Skull", condition = { it is net.minecraft.entity.projectile.EntityWitherSkull }, priority = Int.MAX_VALUE - 200)
        private val undefined = Entity("Undefined", condition = {true}, priority = Int.MIN_VALUE)

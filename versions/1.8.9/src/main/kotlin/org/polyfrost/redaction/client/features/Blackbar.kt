...
object BlackBar {
    ...
    private val timerTask: ActionListener = ActionListener {
        ...
        if (entityplayer != null && Minecraft.getInstance().player != null && Minecraft.getInstance().world != null) {
            data?.let {
    ...
    fun render() {
        data?.let {
            entityplayer = Minecraft.getInstance().renderViewEntity as EntityPlayer
